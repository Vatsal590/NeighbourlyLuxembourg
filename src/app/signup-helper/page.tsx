...
export default function HelperSignupPage() {
  ...
  const submit = (event: FormEvent) => {
    ...
    setSaving(true)
    try { saveLocalHelper(fields); window.location.assign('/helpers?message=helper-joined') } catch { setServerError('We could not save your details on this device. Please check your browser storage settings.') } finally { setSaving(false) }
  }
