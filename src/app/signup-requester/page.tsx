...
export default function RequesterSignupPage() {
  ...
  const submit = (event: FormEvent) => {
    ...
    setSaving(true)
    try { saveLocalRequester(fields); window.location.assign('/helpers?message=requester-joined') } catch { setServerError('We could not save your details on this device. Please check your browser storage settings.') } finally { setSaving(false) }
  }
